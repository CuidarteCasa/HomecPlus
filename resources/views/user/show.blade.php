...
<!--end::Navigation-->
        ...
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <div class="mt-2">
                    <a href="#" class="btn btn-sm btn-primary font-weight-bold mr-2 py-2 px-3 px-xxl-5 my-1">Mensaje</a>
        ...
        <!--begin::Nav-->
        <div class="navi navi-bold navi-hover navi-active navi-link-rounded navi-tabs">

            {{\App\Http\Controllers\PagesController::UsertabMenu()}}
...
@include('layout.partials.extras._toolbarUser')
@include('user.modals.toolbar')
@endsection
