...
@section('content')
 ...
 <!--begin::Card-->
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0 bg-success">
										<div class="card-title">
											<h3 class="card-label">Ordenes de trabajo activas
									...
									<div class="card-body">
										...
										<!--end: Search Form-->
										<!--begin: Datatable-->
										<table class="datatable datatable-bordered datatable-head-custom" id="Kt_activeOrders">
											<thead class="text-dark bg-light-primary">
...
@include('layout.partials.extras._toolbarProgramer')
@include('programador.modals.general');
...
@section('scripts')
    ...
    <script src="{{ asset('lib/controlPanel.js') }}" type="text/javascript"></script>
