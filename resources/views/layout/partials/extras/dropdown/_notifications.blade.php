...
@else
    <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url('{{ asset('media/misc/bg-1.jpg') }}')">
        ...
        <h4 class="d-flex flex-center rounded-top">
            ...
            <span class="btn btn-text btn-success btn-sm font-weight-bold btn-font-md ml-2">{{Auth::user()->unreadnotifications->groupBy('id')->count()}}</span>
        </h4>

        {{-- Tabs --}}
        <ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8" role="tablist">
            <li class="nav-item">
                <a class="nav-link active show" data-toggle="tab" href="#topbar_notifications_notifications"  >Pacientes</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#topbar_notifications_events"  >Eventos</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#topbar_notifications_Registers"  >Registros</a>
            </li>
        </ul>
    </div>
@endif
...
<div class="tab-content">
    ...
    <div class="tab-pane" id="topbar_notifications_events" role="tabpanel">
        ...
        <div class="navi navi-hover scroll my-4" data-scroll="true" data-height="300" data-mobile-height="200">
            ...
            {{-- Item Propio --}}    
                ...
                {{\App\Http\Controllers\NotificationsController::PatientUserNotifications()}}
    ...
    {{-- Tabpane --}}
    <div class="tab-pane" id="topbar_notifications_Registers" role="tabpanel">
         {{-- Nav --}}
        <div class="navi navi-hover scroll my-4" data-scroll="true" data-height="300" data-mobile-height="200">

            {{-- Item Propio --}}    

                {{\App\Http\Controllers\NotificationsController::RegistersUserNotifications()}}
