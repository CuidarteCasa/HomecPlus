...
<html lang="en">
    ...
    <head><base href="../../../">
        <meta charset="utf-8" />
        <title>HomeCarePlus | Ingreso</title>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
        ...
        <div class="d-flex flex-column flex-root">
            ...
            <div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
                ...
                <div class="login-aside order-2 order-lg-1 d-flex flex-row-auto position-relative overflow-hidden">
                    ...
                    <div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
                        ...
                        <a href="#" class="text-center pt-2">
                            <img src="media/logos/log.png" class="max-h-75px" alt="" />
                        </a>
                        <!--end::Logo-->
                        <!--begin::Aside body-->
                            ...
                            <div class="login-form login-signin py-11">
                                ...
                                @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" type="text" name="identificacion" id="identificacion" type="number" autocomplete="off" />
                                    </div>
                                    <!--end::Form group-->
                                    <!--begin::Form group-->
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg form-control @error('password') is-invalid @enderror" type="password" name="password" id="password"  autocomplete="off" />
                                    </div>
                                    <!--end::Form group-->
                                    <!--begin::Action-->
                            ...
                            <div class="login-form login-forgot pt-11">
                                ...
                                <form class="form" novalidate="novalidate" id="kt_login_forgot_form">
                                    ...
                                    <div class="text-center pb-8">
                                        ...
                                        <p class="text-muted font-weight-bold font-size-h4">Ingrese su correo electronico aqui</p>
                                    </div>
                                    <!--end::Title-->
                                    <!--begin::Form group-->
                                    <div class="form-group">
                ...
                <!--begin::Aside-->
                <!--begin::Content-->
                <div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0" style="background-image: url('media/logos/inicio.png');background-size: contain;">
